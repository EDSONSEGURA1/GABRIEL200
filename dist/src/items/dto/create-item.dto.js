...
class CreateItemDto {
    codigo; // <-- Agregado para cumplir con la base de datos
    categoria; // <-- Agregado para cumplir con la base de datos
    nombre;
    descripcion;
    precio;
    stock;
...
], CreateItemDto.prototype, "codigo", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateItemDto.prototype, "categoria", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
